...
def extract_raw_features(image, stick_detector):
    ...
    Args:
        kpts: [33, 4] MediaPipe keypoints
        stick_keypoints: [2, 4] YOLO stick keypoints
        
    Returns:
        dict of features
    """
    stick_grip, stick_tip = stick_keypoints[0], stick_keypoints[1]
    features = {}
    
    # Joint angles (using 3D world coordinates for accuracy if available, but normalized works)
