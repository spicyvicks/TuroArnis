...
**`model_front_v5_deploy.pth`** — Front-view specialist, 76.3% real-only accuracy
- 13 classes (including `neutral`)
- 6-dim node features + 46 hybrid features
- 69,541 parameters
- CPU inference optimized
- Source: `model_front_with_synthetic_3x_v5.pth` (epoch 41, val_acc 62.1%)
- Evaluated: 2026-04-30

## Files Included

### Models
- `models/model_front_v5_deploy.pth` (861 KB) — Active v5 deployment model (76.3%)
- `models/model_front_v6_deploy.pth` (~880 KB) — Active v6 deployment model (72.2%, masked pooling)
- Legacy: `models/hybrid_gcn_v2_front.pth` (1.35 MB) — Superseded by v5/v6
...
- 72.2% real-only test accuracy (masked pooling architecture)
...
- Cleaner architecture, 4.1% below v5 but more robust
...
- 76.3% real-only test accuracy (exceeds 70% target)
- 13 classes with `neutral` support
